...
const Interior = () => {
  return (
    ...
    <div className="font-normal text-white lg:p-[80px] md:p-[80px] sm:p-[40px] py-[20px] px-[40px]">
      <p className='lg:text-[58px] md:text-[58px] sm:text-[38px] text-[38px]'>Interior Design</p> 
      <img src="images/interior.png" alt="logo" className='py-[20px]' />
    </div>
    <div className='lg:px-[80px] md:px-[80px] px-[40px] text-white lg:pb-[80px] md:pb-[80px] pb-[40px]'>
      <p className='lg:text-[52px] md:text-[52px] sm:text-[38px] text-[38px]'>How it works</p> 
      <p className='font-poppins lg:text-[18px] md:text-[18px] text-[12px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
        <div className='lg:flex  md:flex justify-center items-center py-[60px]'>
            ...
            <div className="font-normal text-white w-full lg:ps-[40px] md:ps-[40px] pt-[20px]">
        ...
        <div className='lg:flex lg:flex-row-reverse md:flex '>
            <div className='w-full lg:ps-[40px] md:ps-[40px]  pb-[20px]'>
