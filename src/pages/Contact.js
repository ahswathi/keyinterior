      ...
      <div className='p-[80px]'>
        <div className="flex justify-center items-center pb-[20px]">
          <div className="font-normal text-white pe-[40px]">
            <p className='text-[58px]'>Contact us</p> 
            <p className='text-[18px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry</p> 
          </div>
          <div className='w-full'>
            <img src="images/contact.png" alt="logo" />
          </div>
        </div>
        <div className="font-normal text-white pe-[40px] text-center py-[80px]">
           <p className='text-[52px]'>Google map</p> 
        ...
        <div className='flex justify-between items-between'>
          <div className='text-[22px] py-[80px]'>
        ...
        <div className='flex items-center bg-[#0C0B0A] rounded-s-[44px] '>
          <div className='px-[40px] '>
            <div className="font-normal text-white pb-[30px]">
              <p className='text-[52px]'>Enquire now</p> 
              <p className='text-[18px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p> 
            </div>
            <div className='flex-col'>
              ...
              <button className='text-[#000000] font-bold	text-[14px] px-8 py-2 w-[100%] bg-[#FFC12B] my-[20px]'>SEND</button>
            </div>
          ...
          <div>
            <img src="images/contact2.png" alt="logo" className='rounded-e-[44px]'/>
          </div>
        </div>
      </div>
    </Layout>
