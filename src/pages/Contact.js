        ...
        <div className='lg:flex  md:flex  items-center bg-[#0C0B0A] rounded-s-[44px] '>
          <div className='px-[20px] lg:px-[40px] md:px-[40px]'>
            ...
            <div className='flex-col font-poppins '>
              ...
              <button className='text-[#000000] font-bold	text-[14px] px-8 py-2 w-[100%] bg-[#FFC12B] my-[20px]
               hover:bg-transparent hover:text-white hover:border-[#FFC12B] hover:border transition-colors duration-300'>SEND</button>
            </div>
            <div className='font-poppins lg:flex  md:flex sm:flex justify-between lg:pt-[40px] md:pt-[40px] py-[20px]'>
