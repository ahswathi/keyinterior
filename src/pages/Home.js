...
const Home = () => {
  return (
    <Layout>
        ...
        <p className="lg:text-[58px] md:text-[58px] sm:text-[48px] hidden  lg:block md:block font-normal text-white lg:p-[80px] md:p-[80px] sm:pt-[20px]  sm:px-[80px] 
        ...
        <div  className='enquire-img'>
          ...
          <div className="enquire-text font-normal text-white sm:px-[80px] lg:pt-[40px] pt-[10px] pb-[40px] text-center top-[25%] lg:top-[20%] lg:left-[15%]">
