...
const About = () => {
  return (
    ...
    <div className='text-white lg:p-[80px] md:p-[40px] sm:p-[40px] px-[20px] '>
      <p className='lg:text-[52px] md:text-[38px] sm:text-[38px] text-[38px] text-center lg:text-left'>Who we are</p> 
      <p className='font-poppins lg:text-[18px] md:text-[12px] text-[12px]  font-normal	text-center lg:text-left'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
